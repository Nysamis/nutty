...
ActiveRecord::Schema.define(version: 20140321200457) do
  ...
  add_index "line_items", ["itemized_id", "itemized_type"], name: "index_line_items_on_itemized_id_and_itemized_type"
